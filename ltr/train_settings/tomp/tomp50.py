...
def run(settings):
    ...
    settings.train_samples_per_epoch = 40
    settings.val_samples_per_epoch = 10
    ...
    coco_valid = MSCOCOSeq(settings.env.coco_val_dir)
    ...
    dataset_train = sampler.DiMPSampler([coco_train], [1,1],
    ...
    dataset_val = sampler.DiMPSampler([coco_valid], [1], samples_per_epoch=settings.val_samples_per_epoch,
